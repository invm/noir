...
pub async fn raw_query(pool: &PgPool, query: &str) -> Result<Vec<Value>> {
...
pub async fn execute_query(pool: &PgPool, query: &str, t: QueryType) -> Result<ResultSet> {
...
pub async fn execute_tx(pool: &PgPool, queries: Vec<&str>) -> Result<()> {
